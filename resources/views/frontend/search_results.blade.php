                ...
                <div class="single-property">
                    <div class="images">
                        <img class="img-fluid mx-auto d-block"
                             src="/reality/storage/app/public/inzeraty/inzerat_<?php echo $fotka ?>/fotka_1.png" alt="">
                        <span>Typ predaja</span>
                    </div>

                    <div class="desc">
                        <div class="top d-flex justify-content-between">
                            <h5><a href="<?php echo url('/inzerat/'.$fotka.'/');?>">{{$ads->title}}</a></h5>
                        </div>
                        ...
                        <div class="bottom d-flex justify-content-start">
                            <p><span class="lnr lnr-map-marker"></span>Poloha:</p>
