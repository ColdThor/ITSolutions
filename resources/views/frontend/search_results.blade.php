                ...
                <div class="single-property">
                    <div class="images">
                        <a href="<?php echo url('/inzerat/'.$fotka.'/false'); ?>" style="color: black">
                            <img class="img-fluid mx-auto d-block" src="{{ asset('public/storage/inzeraty/inzerat_'.$fotka."/fotka_1.png") }}" alt="">
                        </a>
                        <span>{{$ads->type}} </span>
                    </div>
                    <div class="desc">
                ...
                <div class="single-property">
                    <div class="images">
                        ...
                        <?php
                                ...
                                while($id) {
                                    if(isset($image_title[$k])  && isset($image_title[$k-1]) && $image_title[$k] == $image_title[$k-1]) {
                                        if(isset($nazov[$i]) && isset($nazov[$i-1]) && $nazov[$i] == $nazov[$i-1]) {
                                         $k++;
                                            $id = false;
                                            }
                                            $k++;
                        ...
                        <?php if(isset($nazov[$i]) && !in_array($nazov[$i],$image_title)): ?>
